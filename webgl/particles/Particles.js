...
export default class Particles {
  ...
  initPoints(discard) {
    ...
    const vs = glslify(vertexShader);
    const fs = glslify(fragmentShader);
    ...
    console.log('creating object 3d');
  ...
  initHitArea() {
    ...
    const material = new THREE.MeshBasicMaterial({ color: 0xFFFFFF, wireframe: true, depthText: false });
